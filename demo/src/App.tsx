          ...
          <div className="container">
            <div className="navbar-brand">
              <a
                ...
                href="https://github.com/headmandev/react-side-drawer"
                target="_blank"
              >
        ...
        <div className="container">
          <div className="columns">
            <div className="column">
              <div className="fixed">
                <h1 className="title mb-2">react-side-drawer</h1>
                <p className="subtitle">
                🔥 Easy to use and flexible
                  <br />
                  screen-side modal component
                </p>
                <code className="language-html p-2">npm i react-side-drawer</code>
              </div>
            </div>
            <div className="column is-three-quarters">
              ...
              <p className="github-link">
                <a href="https://github.com/headmandev/react-side-drawer" target="_blank" rel="noreferrer">
                  👉 Github
                </a>
              </p>
            </div>
